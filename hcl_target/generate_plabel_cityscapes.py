...
SAVE_PATH = './data/Cityscapes/pseudo/train'

if not os.path.isdir('./data/Cityscapes/pseudo/'):
    os.mkdir('./data/Cityscapes/pseudo/')
    os.mkdir(SAVE_PATH)
...
if __name__ == '__main__':
    with torch.no_grad():
        save_path = main()
    #os.system('python compute_iou.py ./data/Cityscapes/gtFine/train %s'%save_path)
