...
cfg.DATA_LIST_TARGET_Bdds = str(project_root / 'advent/dataset/bdds_list/{}.txt')
cfg.DATA_LIST_TARGET_vistass = str(project_root / 'advent/dataset/vistass_list/{}.txt')
# Directories
cfg.DATA_DIRECTORY_SOURCE = str(project_root / 'data/GTA5')
cfg.DATA_DIRECTORY_TARGET = str(project_root / 'data/Cityscapes')
cfg.DATA_DIRECTORY_TARGET_Bdds = str(project_root / 'data/bdd100k')
cfg.DATA_DIRECTORY_TARGET_vistass = str(project_root / 'data/vistas')
...
cfg.TRAIN.INFO_TARGET_Bdds = str(project_root / 'advent/dataset/bdds_list/info.json')
cfg.TRAIN.INFO_TARGET_vistass = str(project_root / 'advent/dataset/vistass_list/info.json')
...
cfg.TEST.INFO_TARGET_Bdds = str(project_root / 'advent/dataset/bdds_list/info.json')
cfg.TEST.INFO_TARGET_vistass = str(project_root / 'advent/dataset/vistass_list/info.json')
